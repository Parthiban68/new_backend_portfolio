      ...
      <div className="relative mx-auto max-w-[1500px] w-full px-6 md:px-12 lg:px-16 flex flex-col lg:flex-row items-center z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <div className="inline-flex items-center gap-2.5 px-3 py-1.5 rounded-full  bg-neutral-50 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
          ...
          <motion.h2
            ...
            className="text-[56px] leading-[0.95] lg:text-[60px] lg:leading-[0.9] tracking-tighter font-semibold text-[#0A0A0A] mb-10"
          >
            Lets's Connect
          </motion.h2>
          ...
          <motion.div
            variants={itemVariants}
            className="grid grid-cols-2 gap-x-8 gap-y-6 py-6 border-y border-black/[0.06] mb-10 max-w-[500px]"
          >
            <div>
              <span className="block text-[11px] uppercase tracking-[0.06em] text-neutral-400 font-semibold mb-1.5">
                Current Focus
              </span>
              <span className="block text-[15px] text-neutral-900 font-medium">
                Scalable Systems & UI
              </span>
            </div>
            <div>
          ...
          <motion.p
            variants={itemVariants}
            className="text-[16px] lg:text-[18px] leading-[1.6] text-[#666666] max-w-[540px] mb-10"
          >
          ...
          >
            <a
              ...
              className="group relative flex items-center justify-center gap-2 h-[52px] px-7 bg-[#0A0A0A] text-white rounded-full text-[15px] font-medium transition-all duration-300 hover:bg-neutral-800 hover:-translate-y-0.5 hover:shadow-lg focus:outline-none"
            >
            ...
            <a
              ...
              className="group flex items-center gap-1.5 text-[15px] font-medium text-neutral-600 hover:text-neutral-900 transition-colors"
            >
        ...
        {/* <div className="w-full lg:w-[45%] lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2 mt-16 lg:mt-0 flex justify-center lg:justify-end z-0">
          <SystemVisualization />
           ...
           <div className="w-full lg:w-1/2 h-[500px] lg:h-[600px] relative bg-whiteshadow-sm overflow-hidden flex-shrink-0">
          ...
          <div className="absolute top-[20%] left-[15%] -rotate-6 z-10 group cursor-pointer hover:-translate-y-1 transition-transform">
            ...
            <a href="mailto:parthibanm1268@gmail.com" className="bg-white border-2 border-black rounded-xl px-4 py-2 flex items-center gap-2 shadow-[2px_4px_0px_0px_rgba(0,0,0,0.15)]">
              ...
              <span className="font-bold text-sm tracking-widest">EMAIL</span>
            </a>
          </div>
          ...
          <div className="absolute top-[22%] right-[15%] rotate-3 z-10 group cursor-pointer hover:-translate-y-1 transition-transform">
            ...
            <a href="https://github.com/Parthiban68" className="bg-white border-2 border-black rounded-xl px-4 py-2 flex items-center gap-2 shadow-[2px_4px_0px_0px_rgba(0,0,0,0.15)]">
          ...
          <div className="absolute top-[42%] left-[12%] rotate-3 z-10 group cursor-pointer">
            ...
            <a href="https://www.linkedin.com/in/m-parthiban/" className="bg-white border-2 border-black rounded-xl px-4 py-2 flex items-center gap-2 shadow-[2px_4px_0px_0px_rgba(0,0,0,0.15)] relative">
              ...
              <span className="font-bold text-sm tracking-widest">LINKEDIN</span>
            </a>
          </div>
          ...
          <div className="absolute top-[60%] left-[24%] -rotate-[4deg] z-20 cursor-pointer">
            ...
            <NavLink to={"/contact"} className="bg-gray-100 border-2 border-black rounded-xl px-5 py-2.5 flex items-center gap-2 shadow-[2px_6px_0px_0px_rgba(0,0,0,0.25)] relative z-10">
              ...
              <span className="font-bold text-[15px] tracking-widest">Let's Work Together</span>
            </NavLink>
          </div>
          ...
          <div className="absolute top-[52%] right-[10%] rotate-6 z-10 group cursor-pointer hover:-translate-y-1 transition-transform">
            ...
            <div className="bg-white border-2 border-black rounded-xl px-4 py-2 flex items-center gap-2 shadow-[2px_4px_0px_0px_rgba(0,0,0,0.15)]">
              ...
              <span className="font-bold text-sm tracking-widest">WHATSAPP</span>
            </div>
          </div>
          ...
          <div className="absolute top-[44%] right-[25%] z-0">
            <span className="text-[10px] font-bold tracking-wider text-gray-600">CONNECT WITH ME →</span>
          </div>

          <div className="absolute bottom-[25%] left-[8%] z-0">
            <span className="text-[10px] font-bold tracking-wider text-gray-600">PICK A WAY TO CONNECT →</span>
          </div>
